  ...
  if(event.tag == 'sync-new-posts'){
    ...
    event.waitUntil(
      readAllData('sync-posts')
        .then(function(data){
          for(var dt of data){
            fetch('https://us-central1-pwagram-efcaa.cloudfunctions.net/storePostData', {
                method: 'POST', 
                headers: {
                ...
                body: JSON.stringify({
                  ...
                  image: 'https://firebasestorage.googleapis.com/v0/b/pwagram-efcaa.appspot.com/o/sf-boat.jpg?alt=media&token=282043c7-4111-42dc-9359-14c18dc0d29d'
                })
              })
                .then(function(res){
